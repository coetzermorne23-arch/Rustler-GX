class VictronLiveData {
  ...
  VictronLiveData copyWith({
    ...
    return VictronLiveData(
      ...
      consumedAh:
          consumedAh ?? this.consumedAh,

      remainingMinutes:
          remainingMinutes ?? this.remainingMinutes,

      starterVoltage:
          starterVoltage ?? this.starterVoltage,

      midpointVoltage:
          midpointVoltage ?? this.midpointVoltage,
      ...
      chargerError:
          chargerError ?? this.chargerError,
