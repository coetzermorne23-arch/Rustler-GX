...
class MediaControlCard extends StatefulWidget {
  ...
  @override
  State<MediaControlCard> createState() =>
      _MediaControlCardState();
}

class _MediaControlCardState
    extends State<MediaControlCard> {
  final MediaSessionService media =
      MediaSessionService.instance;

  final MediaLauncherService launcher =
